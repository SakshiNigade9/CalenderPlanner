  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">Monitor activities and AI insights.</p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-5 w-full md:w-auto">
        ...
        >
          ...
          <div className="hidden sm:block">
            <h3 className="text-white font-semibold text-sm leading-tight">Admin User</h3>
            <p className="text-gray-400 text-xs mt-0.5">MCA Department</p>
          </div>
        </motion.div>
      </div>
    </motion.div>
