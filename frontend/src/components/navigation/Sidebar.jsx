...
const menuItems = [
  { title: "Dashboard", icon: LayoutDashboard, path: "/", roles: ["admin", "president", "warrior"] },
  // WARRIOR ONLY
...
},
 {
  ...
  { title: "Settings", icon: Settings, path: "/settings", roles: ["admin", "president", "warrior"] },
];
...
// Filter items based on user role - added a check to prevent errors if profile is missing
  ...
  return (
    <motion.div
      ...
      className="w-72 min-h-screen bg-[#0b1120] border-r border-white/5 relative z-50 isolation-isolate flex flex-col justify-between"
    >
